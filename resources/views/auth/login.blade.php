    ...
    <div class="authentication-inner row">
      <div class="d-none d-lg-flex col-lg-7 p-0">
        <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
          ...
          <img src="{{ asset('assets/img/illustrations/bg-shape-image-light.png') }}" alt="auth-login-cover"
            class="platform-bg" data-app-light-img="img/illustrations/bg-shape-image-light.png"
            data-app-dark-img="img/illustrations/bg-shape-image-dark.png" />
      ...
      <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
        <div class="w-px-400 mx-auto">
              ...
              <span class="app-brand-logo demo">
                <svg width="32" height="22" viewBox="0 0 32 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path opacity="0.06" fill-rule="evenodd" clip-rule="evenodd"
                    d="M7.69824 16.4364L12.4835 20.8844L15.4218 21.9629L19.9234 16.4364H7.69824Z" fill="#161616" />
                  <path opacity="0.06" fill-rule="evenodd" clip-rule="evenodd"
                    d="M18.4804 16.4364L22.8631 20.8844L25.8014 21.9629L30.303 16.4364H18.4804Z" fill="#161616" />
                  <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <h4 class="mb-1 pt-2">¡Bienvenido a Ventasfix! 👋</h4>
          ...
          <div class="d-flex justify-content-center">
            <a href="javascript:;" class="btn btn-icon btn-text-facebook rounded-pill">
              <i class="tf-icons ti ti-brand-facebook-filled"></i>
            </a>

            <a href="javascript:;" class="btn btn-icon btn-text-twitter rounded-pill">
              <i class="tf-icons ti ti-brand-twitter-filled"></i>
            </a>

            <a href="javascript:;" class="btn btn-icon btn-text-github rounded-pill">
              <i class="tf-icons ti ti-brand-github-filled"></i>
            </a>

            <a href="javascript:;" class="btn btn-icon rounded-pill btn-text-google-plus">
