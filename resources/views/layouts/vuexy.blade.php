...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/@tabler/icons-webfont@3.35.0/dist/font/tabler-icons.min.css"
        rel="stylesheet" />
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    @auth
                                                        ...
                                                        <small
                                                            class="text-muted">{{ auth()->user()->role ?? 'Admin' }}</small>
                                                    @else
                        ...
                        <div class="container-xxl">
                            <div
                                ...
                                <div class="text-body">
                                    ...
                                    , Hecho con ❤️ por <a href="#" target="_blank" class="footer-link">VentasFix</a>
                                </div>
                            </div>
                        </div>
                    </footer>
