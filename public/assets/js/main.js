...
(function () {
    ...
    const switchImagesList = Array.from(
        document.querySelectorAll("[data-app-light-img], [data-app-dark-img]")
    );
    ...
    function switchImage(style) {
        ...
        switchImagesList.map(function (imageEl) {
            ...
            const normalizedAssetsPath = assetsPath.endsWith("/")
                ? assetsPath
                : assetsPath + "/";
            const normalizedSetImage = setImage.startsWith("/")
                ? setImage.slice(1)
                : setImage;
            imageEl.src = normalizedAssetsPath + normalizedSetImage;
        });
    }
